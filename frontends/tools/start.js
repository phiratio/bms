...
import webpackCogs from './webpack.config';
...
const webpackConfig = webpackCogs[sourceFolder];
...
async function start() {
  ...
  const devPortIndex = process.argv.indexOf('--dev-port');
  const devPort =
    devPortIndex > -1 && devPortIndex + 1 <= process.argv.length
      ? process.argv[devPortIndex + 1]
      : 3000;
