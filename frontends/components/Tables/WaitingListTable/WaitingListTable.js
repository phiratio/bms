...
class WaitingListTable extends React.Component {
  ...
  columns = [
    {
      Header: <FontAwesomeIcon className="svgIcon" icon={faUser} />,
      accessor: 'avatar',
      ...
      Cell: props => (
        <Avatar
          ...
          facebookId={get(props.original, 'user.facebookId', false)}
    ...
    },
    {
      ...
      className: 'text-center',
      Cell: props => {
        if (!moment(props.original.apptStartTime).isSame(new Date(), 'day')) {
          return moment(props.original.apptStartTime).format(window.App.dateFormat);
        }
    ...
    {
      Header: <FontAwesomeIcon className="svgIcon" icon={faLightBulb} />,
      accessor: 'status',
      className: 'text-center',
      minWidth: 40,
      sortable: false,
    ...
    {
      Header: <FontAwesomeIcon className="svgIcon" icon={faEllipsisH} />,
