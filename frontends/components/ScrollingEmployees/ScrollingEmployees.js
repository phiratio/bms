...
const ScrollingEmployees = props => {
  ...
  return (
    <div
      ...
      className={classNames('scrolling-wrapper', 'mt-4', 'text-center', {
    ...
    >
      {list.length !== 0 ? (
        list.map(el => {
          ...
          if (props.disabled) {
            if (props.selected.indexOf('Anyone') > -1) {
              ...
              else classList = 'disabled active';
            } else {
              classList =
                props.selected.indexOf(el.name) > -1
                  ? 'active disabled'
                  : 'disabled';
            }
          } else if (props.selected.indexOf('Anyone') > -1) {
            if (el.name !== 'Anyone') classList = 'disabled';
          ...
          return (
            <div
              ...
              onClick={() => {
                !props.disabled &&
                  props.onClick(el.name, props.singleSelect && true);
              }}
            >
        ...
        <div className="not-found text-muted text-center">
