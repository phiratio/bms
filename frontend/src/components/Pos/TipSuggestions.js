  ...
  constructor(props) {
    ...
    this.state = {
      tipSuggestion1Enabled:
        this.props.tipSuggestion1 != null
          ? this.props.tipSuggestion1.isEnabled
          : false,
      tipSuggestion2Enabled:
        this.props.tipSuggestion2 != null
          ? this.props.tipSuggestion2.isEnabled
          : false,
      tipSuggestion3Enabled:
        this.props.tipSuggestion3 != null
          ? this.props.tipSuggestion3.isEnabled
          : false,
      tipSuggestion4Enabled:
        this.props.tipSuggestion4 != null
          ? this.props.tipSuggestion4.isEnabled
          : false,
    ...
    this.onTipSuggestion1EnabledChange = this.onTipSuggestion1EnabledChange.bind(
      this,
    );
    this.onTipSuggestion2EnabledChange = this.onTipSuggestion2EnabledChange.bind(
      this,
    );
    this.onTipSuggestion3EnabledChange = this.onTipSuggestion3EnabledChange.bind(
      this,
    );
    this.onTipSuggestion4EnabledChange = this.onTipSuggestion4EnabledChange.bind(
      this,
    );
    this.tipSuggestion1PercentageChange = this.tipSuggestion1PercentageChange.bind(
      this,
    );
    this.tipSuggestion2PercentageChange = this.tipSuggestion2PercentageChange.bind(
      this,
    );
    this.tipSuggestion3PercentageChange = this.tipSuggestion3PercentageChange.bind(
      this,
    );
    this.tipSuggestion4PercentageChange = this.tipSuggestion4PercentageChange.bind(
      this,
    );
    ...
    return (
      <div className="tip_suggestions">
        ...
        <div className="tipSuggestion">
          <input
            className="tip_suggestion_checkbox"
            type="checkbox"
            ref="manual_entry"
            checked={this.state.tipSuggestion1Enabled}
            onChange={this.onTipSuggestion1EnabledChange}
          />
          <input
            className="tip_suggestion_percentage"
            type="number"
            min={1}
            max={100}
            maxLength={3}
            value={this.state.tipSuggestion1Percentage}
            onChange={this.tipSuggestion1PercentageChange}
          />
          <input
            className="tip_suggestion_label"
            type="text"
            value={this.state.tipSuggestion1Label}
            onChange={this.tipSuggestion1LabelChange}
          />
        </div>
        <div className="tipSuggestion">
          <input
            ...
            type="checkbox"
            ref="manual_entry"
            checked={this.state.tipSuggestion2Enabled}
            onChange={this.onTipSuggestion2EnabledChange}
          />
          <input
            className="tip_suggestion_percentage"
            type="number"
            min="1"
            max="100"
            value={this.state.tipSuggestion2Percentage}
            onChange={this.tipSuggestion2PercentageChange}
          />
          <input
            className="tip_suggestion_label"
            type="text"
            value={this.state.tipSuggestion2Label}
            onChange={this.tipSuggestion2LabelChange}
          />
        </div>
        <div className="tipSuggestion">
          <input
            ...
            type="checkbox"
            ref="manual_entry"
            checked={this.state.tipSuggestion3Enabled}
            onChange={this.onTipSuggestion3EnabledChange}
          />
          <input
            className="tip_suggestion_percentage"
            type="number"
            min="1"
            max="100"
            value={this.state.tipSuggestion3Percentage}
            onChange={this.tipSuggestion3PercentageChange}
          />
          <input
            className="tip_suggestion_label"
            type="text"
            defaultValue={this.state.tipSuggestion3Label}
            onChange={this.tipSuggestion3LabelChange}
          />
        </div>
        <div className="tipSuggestion">
          <input
            ...
            type="checkbox"
            ref="manual_entry"
            checked={this.state.tipSuggestion4Enabled}
            onChange={this.onTipSuggestion4EnabledChange}
          />
          <input
            className="tip_suggestion_percentage"
            type="number"
            min="1"
            max="100"
            defaultValue={this.state.tipSuggestion4Percentage}
            onChange={this.tipSuggestion4PercentageChange}
          />
          <input
            className="tip_suggestion_label"
            type="text"
            defaultValue={this.state.tipSuggestion4Label}
            onChange={this.tipSuggestion4LabelChange}
          />
        </div>
