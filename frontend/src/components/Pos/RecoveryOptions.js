...
export default class RecoveryOptions extends React.Component {
  ...
  queryPayment() {
    ...
    this.unfadeBackground();
    const externalPaymentId = this.state.queryPaymentText;
    this.closePaymentID();
    const request = new clover.sdk.remotepay.RetrievePaymentRequest();
  ...
  getDeviceStatus() {
    ...
    const request = new clover.sdk.remotepay.RetrieveDeviceStatusRequest(false);
  ...
  getDeviceStatusResend() {
    ...
    const request = new clover.sdk.remotepay.RetrieveDeviceStatusRequest(true);
    console.log('RetrieveDeviceStatusRequest', request);
    this.cloverConnector.retrieveDeviceStatus(request);
  }
  ...
  render() {
    const reset = this.state.showReset;
    const showPaymentId = this.state.showPaymentPopup;
      ...
      <div className="recovery_options">
        ...
        {showPaymentId && (
          <div className="enter_payment_id popup">
            <div className="close_popup" onClick={this.closePaymentID}>
              X
            </div>
            <div className="payment_id_body">
              <div className="row center row_padding">
                ...
                <input
                  ...
                  type="text"
                  onChange={this.queryPaymentChange}
                  value={this.state.queryPaymentText}
                />
              </div>
        ...
        <ButtonNormal
          ...
          color="white"
          extra="button_large"
          onClick={this.addPaymentID}
        />
        <ButtonNormal
          title="Pending Payments"
          color="white"
          extra="button_large"
          onClick={this.getPendingPayments}
        />
        <ButtonNormal
          title="Device Status"
          color="white"
        ...
        />
        <ButtonNormal
          title="Device Status (w/message resend)"
          color="white"
          extra="button_large"
          onClick={this.getDeviceStatusResend}
        />
      </div>
    );
  }
